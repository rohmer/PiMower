...
//   GD.Vertex2ii(315, 300, 15);   //Imagen de fondo de  480x156
 ...
 GD.ColorA(255); 
   ...
   GD.Vertex2ii(500, 350, 1);  //si se dibuja

   GD.SaveContext();   
//     GD.VertexTranslateY(16*100);  //no es necesario adicionar a Y, 480 queda dentro de los 511x511 px   
//     GD.VertexTranslateX(16*100);  //adiciona 100 pixeles mas a X,  GD.Vertex2ii(500, 350, 1);    //  dibuja el icono en (500+100, 350), es decir en (600,350), mas alla del limite de 510 px

     GD.VertexTranslateX(16*250);  //adiciona 250 pixeles mas a X,  
     GD.Vertex2ii(500, 350, 1);    //  dibuja el icono en (500+250, 350), es decir en (750,350), mas alla del limite de 511x511 px XD
   GD.RestoreContext();
   ...
   icon3Zoom(0.3);
      ...
      for (int i=0; i<noiconos; i++)
      {  
      GD.VertexTranslateX(16*300); //mueve componente x de vertex2ii 300 pixeles a la derecha XD
      ...
      GD.VertexTranslateX(16*200); //mueve componente x de vertex2ii 200 pixeles a la derecha XD
      ...
      GD.VertexTranslateX(16*100); //mueve componente x de vertex2ii 100 pixeles a la derecha XD
      ...
      GD.VertexTranslateX(16*50); //mueve componente x de vertex2ii 50 pixeles a la derecha XD        
      ...
      GD.VertexTranslateX(16*0); //mantiene los iconos dentro de 511x511
