...
{
public:
	UIText(DriverBase &tft, Rectangle location, std::string text, Theme &elementTheme, eThemeObjState state);	
	UIText(DriverBase &tft, Rectangle location, std::string text, eThemeObjState state, 
