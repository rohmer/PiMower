...
UIButton::UIButton(Adafruit_RA8875 &tft, Rectangle location, std::string boxText,
...
UIButton::UIButton(Adafruit_RA8875 &tft, Rectangle location, std::string buttonText,
...
textLocation = new Point(startX, startY);
	...
	tft.setCursor(textLocation->x, textLocation->y);
