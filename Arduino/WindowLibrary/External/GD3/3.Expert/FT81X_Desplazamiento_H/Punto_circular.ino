...
void Test2()
{
  ...
  Tetha9[1]=random(0,359);    
  Px9[1]= cx + 145*(cos(pi*Tetha9[1]/180));
  Py9[1]= cy + 145*(sin(pi*Tetha9[1]/180));         
  
  Tetha10[1]=random(0,359);    
  Px10[1]= cx + 145*(cos(pi*Tetha10[1]/180));
  Py10[1]= cy + 145*(sin(pi*Tetha10[1]/180));           
...
int Xbase = 0, velX = 1;
 ...
 while(1)
 {
   ...
   GD.Clear();
   GD.Begin(BITMAPS);
   GD.Vertex2ii(0, 0, 15);   //800x450 px, fondo de pantalla
   ...
   icon3Zoom(0.6);   // escala a 60% 
      ...
      Tetha9[1]=Tetha9[1]+deltatetha;  
      if (Tetha9[1]>=360){Tetha9[1]=0;}        
       Px9[1]= cx + 145*(cos(pi*Tetha9[1]/180));
       Py9[1]= cy + 145*(sin(pi*Tetha9[1]/180));           
       GD.Vertex2ii(Px9[1], Py9[1], 1);             
       
      Tetha10[1]=Tetha10[1]-deltatetha;  
      if (Tetha10[1]>=360){Tetha10[1]=0;}        
       Px10[1]= cx + 145*(cos(pi*Tetha10[1]/180));
       Py10[1]= cy + 145*(sin(pi*Tetha10[1]/180));           
       GD.Vertex2ii(Px10[1], Py10[1], 1);       
