...
std::vector<std::string> PiCamera::getImageFiles(std::string directory)
{
	DIR *dir;
	struct dirent *ent;
...
void PiCamera::writeTrainedFiles(std::vector<std::string> filesTrained)
{
