...
void RA8875::bitWrite(volatile uint8_t &x, unsigned int n, bool b) {
	if (n <= 7 && n >= 0) {
		if (b) {
			x |= (1u << n);
		}
...
*/
/**************************************************************************/
bool RA8875::_waitPoll(uint8_t regname, uint8_t waitflag) 
{
	uint8_t temp;
...
*/
/**************************************************************************/
void RA8875::_scanDirection(bool invertH,bool invertV)
{
...
*/
/**************************************************************************/
uint8_t RA8875::getFontWidth(bool inColums) 
{
	uint8_t temp;
	if (bitRead(_TXTparameters,7) == 1){
		temp = _FNTwidth;
...
*/		
/**************************************************************************/
uint8_t RA8875::getFontHeight(bool inRows) 
{
	uint8_t temp;
	if (bitRead(_TXTparameters,7) == 1){
		temp = _FNTheight;
...
*/
/**************************************************************************/
void RA8875::backlight(bool on) //0.69b31 (fixed an issue with adafruit backlight)
{
...
*/
/**************************************************************************/
void RA8875::touchEnable(bool enabled) {
	if (_intPin < 255){
...
bool RA8875::touchCalibrated(void) 
{
	return _calibrated;
}
...
*/
/**************************************************************************/
bool RA8875::_isCalibrated(void) 
{
